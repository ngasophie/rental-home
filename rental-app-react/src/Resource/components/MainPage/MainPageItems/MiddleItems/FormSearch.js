...
class FormSearch extends Component{
    ...
    render(){
        ...
        if(urlRedirect == '/filter-post') return <Redirect to ='/filter-post'/>
        const {dataLocation,filterData} = this.props;
        let city = [];
        let districtsList = {
            city:'',
            districts:[]
...
export default connect(mapStateToProps, mapDispatchToProp) (FormSearch);