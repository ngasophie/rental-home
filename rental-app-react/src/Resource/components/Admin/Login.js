...
class Login extends Component{
        ...
        axios({
            ...
            data: {email,password,role},
                ...
                if(res){
                    ...
                    sessionStorage.setItem('user-login','admin-login');
                    this.setState({
                        email:"",
                    })
    ...
    render(){
        if(sessionStorage.getItem('owner/admin-login') && (sessionStorage.getItem('user-login')=='admin-login')){
            return <Redirect to='/dashboard/admin-page'  />
        }
        return(
